...
game.ReplicatedStorage.GameData.LatestRoom.Changed:Connect(function()
    if not opened and game.ReplicatedStorage.GameData.LatestRoom.Value == 1 then
        ...
        task.spawn(function() local c = 0 while true do SyncWait(c+290) game.ReplicatedStorage.GameData.LatestRoom.Changed:Wait() LoadEntity("Rebound"); SyncWait(c+410) LoadEntity("Rebound"); c=c+450 end end)
